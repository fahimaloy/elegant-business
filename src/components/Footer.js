  ...
  return (
    <footer className="border-t border-neutral-200 mt-16 px-5 md:px-16 py-10 md:py-16">
      <div className="container mx-auto">
        ...
        <p className="mt-8 text-xs">© 2023 <span class="font-bold text-rose-600">System71</span> - All rights reserved</p>
      </div>
    </footer>
  );
};
